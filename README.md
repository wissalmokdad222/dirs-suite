#  DIRS Security Suite — Elite Edition
...
- **Styling**: Vanilla CSS (Custom "Beige Prestige" Design System)
- **Language**: TypeScript
- **Icons**: Lucide React
...
1. Clone the repository:
   ```bash
   git clone https://github.com/wissalmokdad222/dirs-suite.git
   ```
...
The suite utilizes a hierarchical approach to security assessment:
1. **System Layer**: Integrity checks (Root, Bootloader, Security Patches).
2. **Access Layer**: Biometric strength and permission auditing.
3. **Connectivity Layer**: WiFi security and network risk evaluation.
